...
import com.byonecup.proxy.service.TimerMethodInterceptor;
import com.byonecup.proxy.service.UserService;
import net.sf.cglib.proxy.Enhancer;

/**
 * @Title Spring6_Stu Client
 * @Description TODO
 * @Author Turbo
 * @Date 2022/11/24 19:31
 * @Version 1.0
 */
public class Client {
    public static void main(String[] args) {
        ...
        // 建议能够把cglib动态代理生成的代理对象的名字格式有点印象。
...
// 底层本质
// class UserService$$EnhancerByCGLIB$$ddd8cc99 extends UserService()