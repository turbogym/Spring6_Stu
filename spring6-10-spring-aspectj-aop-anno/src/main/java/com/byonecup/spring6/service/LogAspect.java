...
//    @Before("execution(* com.byonecup.spring6.service.UserService.*(..))")
//    public void 增强() {
//        System.out.println("我是一个通知，我是一段增强代码...");
//    }

    // 定义通用的切点表达式
    @Pointcut("execution(* com.byonecup.spring6.service..*(..))")
    public void 通用切点() {
    ...
    // 后置通知
    @AfterReturning("execution(* com.byonecup.spring6.service..*(..))")
    ...
    // 异常通知
    @AfterThrowing("execution(* com.byonecup.spring6.service..*(..))")
    public void afterThrowingAdvice() {
        System.out.println("异常通知");
    }

    // 最终通知（finally语句块中的通知）
    @After("execution(* com.byonecup.spring6.service..*(..))")
